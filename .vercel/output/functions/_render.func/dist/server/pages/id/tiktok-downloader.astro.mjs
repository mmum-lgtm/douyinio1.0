...
const $$TiktokDownloader = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$TiktokDownloader;
  const safeUrl = Astro2.url || new URL("/", Astro2.site || "http://localhost:4321");
  const lang = getLangFromUrl(safeUrl);
  const t = useTranslations(lang);
  const title = t("td.title") ?? "TikTok Video Downloader - Free HD Downloads Without Watermark | TikTokio";
  const description = t("td.description") ?? "Download TikTok videos in HD quality, no watermark, for free. Supports MP4 and audio export.";
  const keywords = t("td.keywords") ?? "tiktok video downloader, download tiktok videos, tiktok hd downloader, no watermark tiktok, tiktokiocam";
...
}, "C:/Users/Omar/Downloads/Compressed/tiktokio3.7/src/pages/id/tiktok-downloader.astro", void 0);

const $$file = "C:/Users/Omar/Downloads/Compressed/tiktokio3.7/src/pages/id/tiktok-downloader.astro";
const $$url = "/id/tiktok-downloader/";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$TiktokDownloader,
  file: $$file,
  url: $$url
