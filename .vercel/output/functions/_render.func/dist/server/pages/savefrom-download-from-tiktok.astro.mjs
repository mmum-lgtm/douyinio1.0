...
const $$SavefromDownloadFromTiktok = createComponent(($$result, $$props, $$slots) => {
  ...
  const favicon = t("savef.favicon") || "https://en1.savefrom.net/img/icon_100.png";
  const variant = "savefrom";
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": title, "description": description, "keywords": keywords, "image": image, "favicon": favicon, "variant": variant }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Hero", $$SavefromHero, {})} ${renderComponent($$result2, "Container", $$Container, {}, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Newsletter", $$SavefromNewsletter, {})} ${renderComponent($$result3, "Features", $$SavefromFeatures, {})} ${renderComponent($$result3, "Faq", $$SavefromFaq, {})} ` })} ` })}`;
}, "C:/Users/Omar/Downloads/Compressed/tiktokio3.7/src/pages/savefrom-download-from-tiktok.astro", void 0);

const $$file = "C:/Users/Omar/Downloads/Compressed/tiktokio3.7/src/pages/savefrom-download-from-tiktok.astro";
const $$url = "/savefrom-download-from-tiktok/";
