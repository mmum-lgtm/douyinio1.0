...
const $$TiktokPhotoDownloader = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$TiktokPhotoDownloader;
  const safeUrl = Astro2.url || new URL("/", Astro2.site || "http://localhost:4321");
  const lang = getLangFromUrl(safeUrl);
  const t = useTranslations(lang);
  const title = t("dft.title") ?? "TikTok Video Downloader - Free HD Downloads Without Watermark | TikTokio";
  const description = t("dft.description") ?? "Download TikTok videos in HD quality, no watermark, for free. Supports MP4 and audio export.";
  const keywords = t("dft.keywords") ?? "tiktok video downloader, download tiktok videos, tiktok hd downloader, no watermark tiktok, tiktokiocam";
...
}, "C:/Users/Omar/Downloads/Compressed/tiktokio3.7/src/pages/de/tiktok-photo-downloader.astro", void 0);

const $$file = "C:/Users/Omar/Downloads/Compressed/tiktokio3.7/src/pages/de/tiktok-photo-downloader.astro";
const $$url = "/de/tiktok-photo-downloader/";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$TiktokPhotoDownloader,
  file: $$file,
  url: $$url
